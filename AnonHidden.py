...
def install():
   ...
   if syst[1] == ("Ubuntu" or "ubuntu" or "Debian" or "debian" or "Parrot" or "Kali" or "kali"):
      ...
      os.system("sudo pacman -S bleachbit")
      time.sleep(2)
      print""+colorr+"==> Creating Directory Tor"+RESET+""
      os.system("sudo mkdir -p /etc/tor")
      time.sleep(1.5)
      ...
      os.system("sudo dnf install bleachbit")
      time.sleep(2)
      print""+colorr+"==> Creating Directory Tor"+RESET+""
      os.system("sudo mkdir -p /etc/tor")
      time.sleep(1.5)
...
def check():
    ...
    try:
        ...
        print"" + colorr + "==> Error connecting. Check your connection\n" + RESET + ""
        exit()
...
def start():
   ...
   if os.system("pgrep tor > /dev/null") != 0:   	
      ...
      pass
   print  ""+ colorr + "==> Stop Filter Firewall" + RESET +""
   os.system ("sudo iptables -t nat -F OUTPUT")
   os.system ("sudo iptables -t filter -F OUTPUT")
   time.sleep(0.5)
   print  ""+ colorr + "==> Killing Applications" + RESET +""
   os.system("sudo killall -q chrome dropbox iceweasel skype icedove thbird firefox chromium xchat transmission > /dev/null")
...
def about():
    ...
    time.sleep(1)
    print""+colorr+"==> Version: 4.0.0"+RESET+""
    time.sleep(1)
...
if sys.argv[1:] == []:
    print("")
    print(""+colorr+"Usage: sudo python AnonHidden.py [OPTIONS]")
    print(""+colorr+"""
    ...
    if sys.argv[1] == "--install":
        try:
            ...
            print"\n"
            print"" + colorr + "==> Ctrl+C pressed...leaving." + RESET + ""
            time.sleep(1)
            print"" + colorr + "==> Thank You :)\n" + RESET + ""
            exit()
